...
export const ChoosePizzaForm = ({
	...
	return (
		<div>
			<div className='flex justify-between relative items-center max-[1100px]:flex-col max-[1100px]:px-4 max-[1100px]:pt-18 max-[1100px]:h-[100vh] max-[1100px]:justify-center max-[1100px]:relative max-[1100px]:gap-[20px] max-[1100px]:relative max-[1100px]:overflow-auto max-[1100px]:scroll-auto'>
				...
				>
					...
					<div className=''>
						...
						<div className='max-[1100px]:bottom-0 max-[1100px]:left-0 max-[1100px]:py-4 max-[1100px]:px-4 max-[1100px]:bg-white max-[1100px]:z-8 max-[1100px]:-mx-4 max-[470px]:shadow-[0_4px_30px_rgba(6,5,50,0.1)] max-[1100px]:mb-5'>
							<Button
								status={status}
