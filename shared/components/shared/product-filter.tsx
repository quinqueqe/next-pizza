			...
			<div className='rounded-[30px] bg-[#ececec] pb-5 w-[420px] h-[42px] flex'>
				{sizes.map((size, i) => (
					<div key={i} className='p-1'>
						<button
							className={cn(
								'text-[#000] text-center py-[5px] w-[132px] rounded-4xl select-none transition-all duration-400',
			...
			<div className='rounded-[30px] bg-[#ececec] pb-5 w-[420px] h-[42px] flex'>
				{types.map((type, i) => (
					<div key={i} className='p-1'>
						<button
							className={cn(
								'text-[#000] text-center py-[5px] w-[202px] rounded-4xl select-none transition-all duration-400',
